...
from src.helpers import PATHS, error_fmter
...
def main() -> None:
    ...
    try:
        ...
        integrand = MPIntegrand(graph_properties,
                                ...
                                settings['integrand'],
                                n_cores=settings['tropnis']['n_cores'],
        ...
        params = settings['plotting_params']['training_prog']
        ...
        discrete_model_params = settings[discrete_model]
        batch_size = settings['tropnis']['batch_size']
        gammaloop_state = settings['gammaloop_state']['state_name']
